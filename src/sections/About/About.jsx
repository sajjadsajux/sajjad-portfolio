...
const About = () => {
  return (
    <div className="container mx-auto px-4 text-center md:text-left ">
      ...
      <div className=" space-y-6 mb-10 text-base-100">
        {/* Main intro */}
        <p className="text-lg leading-relaxed ">
          Hi! I'm <span className="font-semibold text-secondary">Sajjad Saju</span>, learning to build full-stack websites using the <strong>MERN stack</strong>. I’ve already worked with <strong>HTML, CSS, JavaScript, React, React Router, and MongoDB</strong>. I enjoy turning ideas into real web
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto">
        {/* Interests & Passions */}
        <div>
          <h3 className="text-xl font-semibold text-secondary mb-2">Your Interests & Passions</h3>
          <ul className="list-disc list-inside  space-y-1 text-base-100">
        ...
        {/* Fun Facts */}
        <div>
          <h3 className="text-xl font-semibold text-secondary mb-2">Fun Facts</h3>
          <ul className="list-disc list-inside  space-y-1 text-base-100">
