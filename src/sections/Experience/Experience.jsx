    ...
    responsibilities: [
      {
        ...
        description: "Developing and maintaining CMS-based e-commerce websites and web applications. Fixing bugs, improving performance, and adding new features based on project requirements.",
      },
    ],
    closing: "",
  },
...
const ExperienceCard = () => {
  ...
  return (
    <section className="bg-[linear-gradient(to_right,_#000428,_#004e92)] pt-12 ">
      <div className="max-w-7xl mx-auto px-4 lg:px-4 text-center md:text-left">
