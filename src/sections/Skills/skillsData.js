export const frontendSkillsIntro = "Frontend development focuses on creating the visual and interactive parts of websites and apps that users see and interact with.";
